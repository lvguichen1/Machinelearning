...
"""
sklearn是python重要的机器学习库，支持包括分类、回归、降维和聚类四大机器学习算法。还包括特征提取、数据处理和模型评估三大模块。
sklearn是Scipy的扩展，建立在Numpy和matplotlib库的基础上。
"""
...
if __name__ == "__main__":
    ...
    # 取对数
    columns_log = ['income', 'tollten', 'longmon', 'tollmon', 'equipmon', 'cardmon', 'wiremon', 'longten', 'tollten',
                   'equipten', 'cardten', 'wireten', ]
    mms = MinMaxScaler()
    ...
    print u'测试集查全率：', recall_score(y_test, y_test_pred)
    print u'测试集f1 Score: ', f1_score(y_test, y_test_pred)
